...
class LocalSuiteLauncher:
    def __init__(self):
        ...
        # - launcher/Market AI runtime assets live in this directory.
        # - investment-dashboard remains a sibling web-resource directory.
    ...
    def _startup(self):
        try:
            ...
            if not (market_ai_dir / "app.py").exists():
                raise RuntimeError(f"Market AI app.py를 찾지 못했습니다: {market_ai_dir}")
    ...
    def _find_market_ai_dir(self) -> Path | None:
        """Compatibility shim: Market AI now lives in the launcher directory."""
        candidate = self.market_ai_dir
        return candidate if (candidate / "app.py").exists() else None
    ...
    def _invoke_efriend_tray_exit(self) -> bool:
        ...
        script = self.launcher_dir / EFRIEND_TRAY_EXIT_SCRIPT
